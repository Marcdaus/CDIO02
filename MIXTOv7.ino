// ============ incluimos la libreria de adafruit ============
#include <Adafruit_ADS1X15.h>
// ============== incluimos la libreria de wifi ==============
...
int canal_humedad = 2; // Canal del ADS1115 por el que mediremos la humedad
...
#define CANAL 1 // Pin de entrada analógica para leer el sensor de temperatura
...
int pHArrayIndex = 0;
static float pHValue, Voltage; // variables que cogen informacion de la funcion para mostrar en tablas

// ============================================================================================

// ============== variables Luminosidad ==============

int canal_luz = 3; // Pin para alimentar el sensor de Luminosidad
double umbralOscuridad[] = {500,1500,3000,4000};  // Definir los umbrales para los niveles de luz
float vout; // valor de voltage
int porcentaje_lum = 0; // variable que guarda el porcentaje de luz
...
// ============ variables Dormir el Sparkfun ============

// Duración del sueño profundo en microsegundos (1 hora)
uint64_t sleepTimeMicroseconds = 3600 * 1000000; // 3600 segundos * 1,000,000 microsegundos
...
void loop() {
 ...
 //===================== ACTIVAR CALIBRADOR ========================
  ...
  // Iniciar el modo de sueño profundo para ahorrar energía.
...
void Luminosidad(){
  ...
  vout=(lecturaADClum*4.096)/30767;
